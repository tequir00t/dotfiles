...
-- {{{ Tags
tags = {
   names = { "web", "term", "docs", "chat", "media", "other" },
   layout = { layouts[1], layouts[3], layouts[4], layouts[1], layouts[1], layouts[1] }
}
...
mytextclock = awful.widget.textclock(markup("#7788af", "%A %d %B ") .. markup("#343639", ">") .. markup("#de5e1e", " %H:%M:%S "),1)
...
globalkeys = awful.util.table.join(
    ...
    awful.key({},
		"Print",
		function()
		    awful.util.spawn("shutter -a",false)
		end),
    -- Tag browsing
...
--    awful.key({ modkey }, "w",
    ...
    awful.key({ modkey,           }, "a",      function () fswidget.show(7) end),
